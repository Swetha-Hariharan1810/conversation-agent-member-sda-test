...
FIELDS
  notification_method  "sms" | "email" | "both"
    ...
    ask the member to choose SMS or email. Never select a channel on the
    member's behalf. This applies to both the initial and timeline
    notification-method questions.
